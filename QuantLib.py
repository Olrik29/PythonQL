...
class BatesModel(CalibratedModel):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
...
class OptionList(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def iterator(self): return _QuantLib.OptionList_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _QuantLib.OptionList___nonzero__(self)
    def __bool__(self): return _QuantLib.OptionList___bool__(self)
    def __len__(self): return _QuantLib.OptionList___len__(self)
    def pop(self): return _QuantLib.OptionList_pop(self)
    def __getslice__(self, *args): return _QuantLib.OptionList___getslice__(self, *args)
    def __setslice__(self, *args): return _QuantLib.OptionList___setslice__(self, *args)
    def __delslice__(self, *args): return _QuantLib.OptionList___delslice__(self, *args)
    def __delitem__(self, *args): return _QuantLib.OptionList___delitem__(self, *args)
    def __getitem__(self, *args): return _QuantLib.OptionList___getitem__(self, *args)
    def __setitem__(self, *args): return _QuantLib.OptionList___setitem__(self, *args)
    def append(self, *args): return _QuantLib.OptionList_append(self, *args)
    def empty(self): return _QuantLib.OptionList_empty(self)
    def size(self): return _QuantLib.OptionList_size(self)
    def clear(self): return _QuantLib.OptionList_clear(self)
    def swap(self, *args): return _QuantLib.OptionList_swap(self, *args)
    def get_allocator(self): return _QuantLib.OptionList_get_allocator(self)
    def begin(self): return _QuantLib.OptionList_begin(self)
    def end(self): return _QuantLib.OptionList_end(self)
    def rbegin(self): return _QuantLib.OptionList_rbegin(self)
    def rend(self): return _QuantLib.OptionList_rend(self)
    def pop_back(self): return _QuantLib.OptionList_pop_back(self)
    def erase(self, *args): return _QuantLib.OptionList_erase(self, *args)
    def __init__(self, *args): 
        this = _QuantLib.new_OptionList(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _QuantLib.OptionList_push_back(self, *args)
    def front(self): return _QuantLib.OptionList_front(self)
    def back(self): return _QuantLib.OptionList_back(self)
    def assign(self, *args): return _QuantLib.OptionList_assign(self, *args)
    def resize(self, *args): return _QuantLib.OptionList_resize(self, *args)
    def insert(self, *args): return _QuantLib.OptionList_insert(self, *args)
    def reserve(self, *args): return _QuantLib.OptionList_reserve(self, *args)
    def capacity(self): return _QuantLib.OptionList_capacity(self)
    __swig_destroy__ = _QuantLib.delete_OptionList
    __del__ = lambda self : None;
OptionList_swigregister = _QuantLib.OptionList_swigregister
